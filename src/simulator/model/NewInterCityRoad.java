...
public class NewInterCityRoad extends Event{
	...
	public NewInterCityRoad(int time, String id, String srcJunc, String destJunc,
	...
	void execute(RoadMap map) {
		...
		Road r = new InterCityRoad(id, map.getJunction(origen), map.getJunction(destino), velocidadMax, CO2limite, longitud, clima);
		map.addRoad(r);
	}
